...
class AddRecipesFragment : Fragment() {
    ...
    private val addNewRecipeUseCase by lazy { recipesRepository?.let { AddNewRecipeUseCase(recipesRepository = it) } }
    ...
    override fun onCreateView(
        ...
        binding.addButton.setOnClickListener {
            adapter
            val recipe = Recipes(id = id.toString(), title = title.text.toString(),
                description = description.text.toString(), ingredients = ingredientsList, steps = steps.text.toString())
